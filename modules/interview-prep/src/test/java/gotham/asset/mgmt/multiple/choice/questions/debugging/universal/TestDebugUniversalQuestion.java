...
public class TestDebugUniversalQuestion extends Question {
    @Override public String getQuestionText() { return "Shared bug"; }
    ...
    @Override public Set<String> getApplicableLanguages() { return Set.of("java","dotnet","scala"); }
}
